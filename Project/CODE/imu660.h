...
#define IMU660RA_SPI                (SPI_4)                                     // 硬件 SPI 号
#define IMU660RA_SPC_PIN            (SPI4_SCK_C23 )                             // 硬件 SPI SCK 引脚
#define IMU660RA_SDI_PIN            (SPI4_MOSI_C22)                             // 硬件 SPI MOSI 引脚
#define IMU660RA_SDO_PIN            (SPI4_MISO_C21)                             // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif
#define IMU660RA_CS_PIN             (SPI4_CS0_C20)                                       // CS 片选引脚
//#define IMU660RA_CS(x)              ((x) ? (gpio_set(IMU660RA_CS_PIN, 1)) : (gpio_set(IMU660RA_CS_PIN, 0)))
