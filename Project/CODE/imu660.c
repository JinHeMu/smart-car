...
uint8 imu660ra_init (void)
{
    ...
    rt_thread_mdelay(10);                                                        // 等待设备上电成功

		spi_init(IMU660RA_SPI, IMU660RA_SPC_PIN, IMU660RA_SDI_PIN, IMU660RA_SDO_PIN, IMU660RA_CS_PIN, 0, 10*1000*1000);//硬件SPI初始化
	// 读取一下设备ID 将设备设置为SPI模式
