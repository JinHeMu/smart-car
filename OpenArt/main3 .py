...
#晚上阈值（需要调试）
card_threshold = [(31, 100, -128, 127, -9, 127)]#色块检测阈值
boundary_threshold = [(55, 100, -128, 127, -9, 127)]#边线检测阈值
boundary_column_threshold = [(55, 100, -128, 127, -9, 127)]#边线检测阈值
boundary_row_threshold = [(55, 100, -128, 127, -9, 127)]#边线检测阈值
day_brightness = 500
